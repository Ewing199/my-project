								...
								<el-form label-width="130px" :rules="rules" size="middle" ref="agency_form" :model="agency_form">
									...
									<el-form-item prop="agency_type">
										...
										<el-radio-group v-model="agency_form.agency_type">
											<el-radio label="养老院"></el-radio>
											<el-radio label="敬老院"></el-radio>
											<el-radio label="老年公寓"></el-radio>
											<el-radio label="护理院"></el-radio>
											<el-radio label="疗养院"></el-radio>
											<el-radio label="养老照料中心"></el-radio>
											<el-radio label="养老社区"></el-radio>
											<el-radio label="福利院"></el-radio>
									...
									<el-form-item prop="agency_user_type">
										...
										<el-radio-group v-model="agency_form.agency_user_type">
										    ...
										    <el-radio label="半自理/介助"></el-radio>
										    <el-radio label="不能自理/介护"></el-radio>
										    <el-radio label="特护"></el-radio>   
										</el-radio-group>
										</el-col>
										 <i>收住对象不能为空白</i>
									</el-form-item>
